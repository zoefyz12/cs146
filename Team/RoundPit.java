 ...
 *
 */
public class RoundPit implements PitStyle
{
    ...
    public RoundPit(int x, int y, int w, int h)
    {
    ...
    /**
     * Draw the pit with correct number of stones
     */
    @Override
    public void draw(Graphics2D g2)
    {
        ...
        drawString(g2, shape.getBounds(), "" + this.stone, font);
